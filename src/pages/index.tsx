...
export default function HomePage() {
  return (
    ...
    ">
      <div className="w-150 h-150 flex flex-col justify-center items-center bg-black/60 text-center border-2 border-glow rounded-lg p-8 shadow-lg">
        ...
        <nav className="flex flex-col gap-4 items-center">
          ...
          <Link href="/dashboard/admin" className="btn-link">
